...
function crearPost(datos){
    ...
    while (i > 0){
        ...
        articulo.innerHTML = '<hr><div class="post"><div class="fift" id="Numero"><p id="NumeroPst">#'+(i+1)+'</p></div><div class="fift" id="fotopost"><div id="foto" ><a href="post.html?post='+keysPost[i]+'"><img src="'+imagen+'" id="foto"</a></div><div id="name"><h2>'+nombre[0]+'</h2></div></div></div>'
